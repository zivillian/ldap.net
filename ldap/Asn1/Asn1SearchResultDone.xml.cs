...
{
    internal sealed partial class Asn1SearchResultDone
    {
        ...
        internal static Asn1SearchResultDone Decode(ReadOnlyMemory<byte> encoded, AsnEncodingRules ruleSet)
        {
            return Decode(Asn1Tag.Sequence, encoded, ruleSet);
        }
        
        internal static Asn1SearchResultDone Decode(Asn1Tag expectedTag, ReadOnlyMemory<byte> encoded, AsnEncodingRules ruleSet)
        {
            AsnReader reader = new AsnReader(encoded, ruleSet);
            
            Decode(reader, expectedTag, out Asn1SearchResultDone decoded);
            reader.ThrowIfNotEmpty();
            return decoded;
        }

        internal static void Decode(AsnReader reader, out Asn1SearchResultDone decoded)
        {
            if (reader == null)
        ...
        internal static void Decode(AsnReader reader, Asn1Tag expectedTag, out Asn1SearchResultDone decoded)
        {
            if (reader == null)
                throw new ArgumentNullException(nameof(reader));

            decoded = new Asn1SearchResultDone();
