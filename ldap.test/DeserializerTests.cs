...
namespace zivillian.ldap.test
{
    public class DeserializerTests
    {
        ...
        public void CanReadCompareRequest()
        {
            ...
            Assert.Equal(Encoding.UTF8.GetBytes("salaried"), compare.Assertion.Value.ToArray());
        }
        ...
        [Fact]
        public void CanReadSnomSearchRequest()
        {
            ...
            var data = new byte[]
            {
                0x30, 0x6c, 0x2, 0x1, 0x2, 0x63, 0x67, 0x4, 0x13, 0x64,
                0x63, 0x3d, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x70, 0x68, 0x6f,
                0x6e, 0x65, 0x2c, 0x64, 0x63, 0x3d, 0x64, 0x65, 0xa, 0x1,
                0x2, 0xa, 0x1, 0x0, 0x2, 0x2, 0x0, 0x32, 0x2, 0x1,
                0x0, 0x1, 0x1, 0x0, 0xa1, 0x1b, 0xa4, 0xc, 0x4, 0x2,
                0x73, 0x6e, 0x30, 0x6, 0x80, 0x4, 0x6d, 0x6a, 0x61, 0x6d,
                0xa4, 0xb, 0x4, 0x1, 0x6c, 0x30, 0x6, 0x80, 0x4, 0x6d,
                0x6a, 0x61, 0x6d, 0x30, 0x23, 0x4, 0x2, 0x73, 0x6e, 0x4,
                0x1, 0x6c, 0x4, 0xf, 0x74, 0x65, 0x6c, 0x65, 0x70, 0x68,
                0x6f, 0x6e, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x4,
                0x9, 0x6a, 0x70, 0x65, 0x67, 0x50, 0x68, 0x6f, 0x74, 0x6f
            };
            var message = Read(data, validateRoundtrip: false);
            Assert.Equal(2, message.Id);
            var search = Assert.IsType<LdapSearchRequest>(message);
            Assert.Equal(50, search.SizeLimit);
        }
